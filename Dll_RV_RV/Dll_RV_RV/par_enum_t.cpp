...
public:
	...
	*/
	...
	virtual void save() override
	{
		...
		out.seekp(13);													//шаг 12 байт     первые 12 байт занимают значения классов par_list_t
	...
	virtual void load() override
	{
		...
		if (out) {
			out.seekg(13);												//шаг 12 байт     первые 12 байт занимают значения классов par_list_t
